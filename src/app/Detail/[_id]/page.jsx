  ...
  return (
    <div>
      <div className="bg-bggris2 relative pt-10 mx-auto min-w-[20rem] w-[90%] rounded-2xl flex flex-col md:flex-row mt-28 mb-10 shadow-md">
        ...
        <div className="bg-white border-solid border-2 border-primary cursor-grab w-[40%] mb-5 md:mr-10 relative overflow-hidden flex items-center justify-center ml-8">
          <Image
