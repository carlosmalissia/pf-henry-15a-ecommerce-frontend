          ...
          <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full h-96" onSubmit={handleSubmit}>
            <div className='flex flex-col'>
              ...
              <input
                ...
                required
                className={`mr-10 bg-gray-50 border border-gray-300 text-black-500 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-teal-500 dark:focus:border-teal-500 ${formErrors.email && 'border-red-500'}`}
              />
              {formErrors.email && (
            ...
            <div className='flex flex-col'>
              ...
              <input
                ...
                required
                className={`mr-10 bg-gray-50 border border-gray-300 text-black-500 text-sm rounded-lg focus:ring-blue-500 focus:border-teal-500 block w-full p-2 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-teal-500 dark:focus:border-teal-500 ${formErrors.password && 'border-red-500'}`}
              />
              {formErrors.password && (
